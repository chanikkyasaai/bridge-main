...
from ml_engine.core.industry_engine import IndustryGradeMLEngine, BehavioralVector, BehavioralEvent, SessionContext
...
async def startup_event():
    """Initialize ML-Engine on service startup"""
    global ml_engine
    ...
    try:
        ...
        health = await ml_engine.get_performance_stats()
...
async def shutdown_event():
    """Cleanup ML-Engine on service shutdown"""
    global ml_engine
    ...
    if ml_engine:
        try:
            ...
            logger.info("✅ ML-Engine shutdown successfully")
        except Exception as e:
