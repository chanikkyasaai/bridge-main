...
from mlengine.adapters.faiss.verifier.layer1_verifier import VerificationResult as L1Result
from mlengine.adapters.level2.layer2_verifier import Layer2Result
from mlengine.core.drift_detection import DriftDetectionResult
...
class PolicyOrchestrator:
    ...
    async def initialize(self):
        ...
        logger.info("Initializing Policy Orchestrator...")
        
        # Initialize risk tracker
        if hasattr(self.risk_tracker, 'initialize'):
            await self.risk_tracker.initialize()
        
        # Clear any existing state
        self.policy_cache.clear()
        self.user_trust_scores.clear()
        self.session_contexts.clear()
        
        logger.info("✓ Policy Orchestrator initialized")
